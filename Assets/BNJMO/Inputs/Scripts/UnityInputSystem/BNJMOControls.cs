// GENERATED AUTOMATICALLY FROM 'Assets/BNJMO/Inputs/Scripts/UnityInputSystem/BNJMOControls.inputactions'
...
public class @BNJMOControls : IInputActionCollection, IDisposable
{
    ...
    public struct PlayerActions
    {
        ...
        public void SetCallbacks(IPlayerActions instance)
        {
            if (m_Wrapper.m_PlayerActionsCallbackInterface != null)
            {
                ...
                @SHOULDER_L.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_L;
                @SHOULDER_L.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_L;
                @SHOULDER_L.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_L;
                @SHOULDER_R.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_R;
                @SHOULDER_R.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_R;
                @SHOULDER_R.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSHOULDER_R;
                @TRIGGER_L.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_L;
                @TRIGGER_L.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_L;
                @TRIGGER_L.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_L;
                @TRIGGER_R.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_R;
                @TRIGGER_R.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_R;
                @TRIGGER_R.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_R;
                @JOYSTICK_L.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_L;
                @JOYSTICK_L.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_L;
                @JOYSTICK_L.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_L;
                @JOYSTICK_R.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_R;
                @JOYSTICK_R.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_R;
                @JOYSTICK_R.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnJOYSTICK_R;
                ...
                @TRIGGER_AXIS_L.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_L;
                @TRIGGER_AXIS_L.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_L;
                @TRIGGER_AXIS_L.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_L;
                @TRIGGER_AXIS_R.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_R;
                @TRIGGER_AXIS_R.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_R;
                @TRIGGER_AXIS_R.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnTRIGGER_AXIS_R;
            }
